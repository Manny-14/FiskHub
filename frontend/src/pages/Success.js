...
const Success = () => {
  return (
    <div className='bg-white w-full max-w-md mx-auto flex flex-col justify-center items-center p-4 gap-2 mix-blend-multiply m-2 rounded'>
        ...
        <Link to={'/dashboard/order'} className='p-2 mt-5 px-3 rounded border-2 border-green-600 font-semibold text-green-600 hover:bg-green-600 hover:text-white transition-all'>View Order</Link>
    </div>
  )
}
